...
* Python에서 사용 가능한 PyKOMORAN
   ...
   * :doc:`/pykomoran/installation` 에서 설치 방법을 확인해보세요.
...
* `Hyunjoong Kim <https://github.com/lovit/komoran3py>`_ 님께서 개발하신 Python 버전의 `KOMORAN3Py <https://github.com/lovit/komoran3py>`_ 도 공개되어 있습니다.
